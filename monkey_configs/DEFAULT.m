function config = DEFAULT()
    ...
    config.device.arduino_port = 'COM3'; % Default Arduino port
    config.device.minInput = 0.5;  % joystick drift threshold
    ...
    config.visual.gap_size = 200; % Gap size in corridor
    ...
    % Game settings
    config.game.premade_eels = true; % If true, load pre-made eels
    ...
    config.game.passive_view_electrical_field = 250;

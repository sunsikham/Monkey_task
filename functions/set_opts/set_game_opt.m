...
function game_opt = initialize_default_game_opt()
    ...
    game_opt.competencies = [0.2, 0.9]; 
    
    game_opt.n_eels = 2;                % Number of eels in the game
    game_opt.eel_sz = 100;               % Size of eels (pixels)
    ...
    game_opt.min_comp_switch = 3;      % Minimum trials between competency switches
    game_opt.max_comp_switch = 4;      % Maximum trials between competency switches
